...
export async function createTask(task) {
  ...
  await sql`
    INSERT INTO tasks (id, text, completed, due_date, priority, category, tags, parent_note_id, project_id, created_at)
    VALUES (${id}, ${task.text}, ${task.completed || false}, ${task.dueDate || null}, ${task.priority || null}, ${task.category || 'wrapmate'}, ${tags}, ${task.parentNoteId || null}, ${task.projectId || null}, ${task.createdAt || new Date().toISOString()})
  `;
